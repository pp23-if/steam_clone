...
<html lang="pt-br">
  ...
  <body>
    ...
    <form>
      ...
      <input type="number" class="inp" name="codigo" id="codigo" placeholder="informe 4 digitos quaisquer" required min="0000" max="9999">
    
       
      <input type="email"  class="inp" name="email" id="email" placeholder="email" required maxlength="50">
